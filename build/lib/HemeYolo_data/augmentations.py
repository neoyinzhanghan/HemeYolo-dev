...
class DeepHemeAugmentor():
    ...
    def Cutout(self, TL_x, TL_y, BR_x, BR_y, replacement_image_path=replacement_image_path):
        ...
        new_image[TL_y:BR_y, TL_x:BR_x] = cv2.addWeighted(new_image[TL_y:BR_y, TL_x:BR_x], 1 - cover_opacity, cv2.imread(replacement_image_path), cover_opacity, 0)
...
if __name__ == '__main__':
    ...
    augmentor.CropNResize(200, 200, 300 ,300)

    augmentor.show_most_recent()