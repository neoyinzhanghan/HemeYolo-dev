...
class RandomAugmentor(DeepHemeAugmentor):
    ...
    def __init__(self, image_path, label_path,
                 ...
                 max_contrast_alpha=1.5,
                 min_contrast_alpha=0.5,
                 max_saturation_alpha=1.5,
                 min_saturation_alpha=0.5,
                 max_hue_alpha=1.5,
                 min_hue_alpha=0.5,
                 max_color_jitter_alpha=1.5,
                 min_color_jitter_alpha=0.5,
                 max_brightness_alpha=1.5,
                 min_brightness_alpha=0.5,
